...
if uploaded_file is not None:
    ...
    st.dataframe(data)
    names = ["𝙶 𝙺 𝙱𝙷𝙰𝚂𝙺𝙰𝚁","𝙻 𝙷𝙰𝚁𝚂𝙷𝙰 𝚅𝙰𝚁𝙳𝙷𝙰𝙽","𝙶 𝚂𝚆𝙰𝚁𝚄𝙿𝙰","𝙺 𝙿𝚁𝙰𝚂𝙰𝙳","𝙺 𝚂𝙷𝚈𝙰𝙼𝙰𝙻𝙰","𝙳 𝚂𝙷𝚈𝙰𝙼","𝙺 𝚄𝙼𝙰 𝚂𝙰𝙸","𝙱 𝚂𝙰𝙸 𝚁𝙰𝙼"]
    ...
    if st.checkbox("CHECK CARS ON YOUR PERSONLIZATION"):
        ...
        data1 = data[(data['Make']==value1) & (data['Type']==value2)&((min_price<= data['Horsepower']) | (data['MSRP'] <=max_price))&(data['Horsepower']==value4)]
        st.write(data1[['Make','Type','MSRP','Horsepower']])
